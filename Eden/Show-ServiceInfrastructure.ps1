...
Write-Host "Click: https://portal.azure.com/#@boundbybetter.com/resource/subscriptions/$((Get-AzSubscription).Id)/resourceGroups/$($EdenEnvConfig.EnvironmentName)-MyEdenService/overview" -ForegroundColor Blue
Write-Host "" -ForegroundColor Blue
