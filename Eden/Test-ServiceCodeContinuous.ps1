...
param(
    ...
    Write-EdenBuildInfo "Testing the MyEdenSolution.MyEdenService.sln Solution continuously using the 'Service.Tests/MyEdenSolution.MyEdenService.Service.Tests'." $LoggingPrefix
