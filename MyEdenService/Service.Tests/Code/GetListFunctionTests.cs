namespace ContentReactor.MyEdenService.Service.Tests.Unit
{
    ...
    public class GetListFunctionTests
    {
        ...
        public async Task WithSuccessReturnsSummaries()
        {
            ...
            fakeBlobRepo.AddFakeBlob(Mockers.MyEdenServiceContainerName, $"{Mockers.DefaultUserId}/newblobname");
        ...
        public async Task WithAnotherUserIdDoesNotReturnSummaries()
        {
            ...
            fakeBlobRepo.AddFakeBlob(Mockers.MyEdenServiceContainerName, "newblobname");
