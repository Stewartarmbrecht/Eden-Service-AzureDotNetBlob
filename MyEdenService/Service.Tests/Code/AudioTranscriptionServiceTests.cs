namespace ContentReactor.MyEdenService.Service.Tests.Unit
{
    ...
    /// </summary>
    [TestClass]
    public class MyEdenServiceTranscriptionServiceTests
    {
        /// <summary>
        ...
        /// </summary>
        [TestMethod]
        public void CreateMyEdenServiceTranscriptRequestReturnsExpectedRequest()
        {
            // arrange
            ...
            // act
            var result = MyEdenServiceTranscriptionService.CreateMyEdenServiceTranscriptRequest(stream);
        ...
        /// </summary>
        [TestMethod]
        public void ProcessMyEdenServiceTranscriptResponseReturnsExpectedResponse()
        {
            // arrange
            ...
            // act
            var response = MyEdenServiceTranscriptionService.ProcessMyEdenServiceTranscriptResponse(responseString);
