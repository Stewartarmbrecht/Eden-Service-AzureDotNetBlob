...
$apiPort = $Env:MyEdenServiceLocalHostingPort

$loggingPrefix = "ContentReactor MyEdenService $instanceName Setup"
...
Invoke-BuildCommand "func azure functionapp fetch-app-settings $instanceName-MyEdenService" $loggingPrefix "Fetching the app settings from azure."
