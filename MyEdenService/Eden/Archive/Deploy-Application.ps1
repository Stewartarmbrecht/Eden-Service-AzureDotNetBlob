...
$loggingPrefix = "ContentReactor MyEdenService Deploy Apps $instanceName"

Write-EdenBuildInfo "Deploying the applications." $loggingPrefix

$resourceGroupName = "$instanceName-MyEdenService".ToLower()
$apiName = "$instanceName-MyEdenService".ToLower()
...
$automatedTestJob = Test-Automated -AutomatedUrl "https://$apiName-staging.azurewebsites.net/api/MyEdenService" -LoggingPrefix $loggingPrefix
