namespace MyEdenSolution.MyEdenService.Service.Tests.Unit
{
    ...
    public class GetFunctionTests
    {
        ...
        [TestMethod]
        public async Task WithSuccessReturnsMyEdenService()
        {
            // arrange
            ...
            Assert.AreEqual($"https://fakerepository/MyEdenService/fakeuserid/{responseObject.Id}?sasToken=Read", responseObject.MyEdenServiceUrl.ToString());
        ...
        /// <returns>Task for running the test.</returns>
        [TestMethod]
        public async Task WithTranscriptMissingReturnsMyEdenServiceNote()
        {
            // arrange
            Mock<ILogger> mockLogger = new Mock<ILogger>();
            var mockRequest = Mockers.MockRequest(null);
        ...
        /// <returns>Task for running the test.</returns>
        [TestMethod]
        public async Task WithInvalidMyEdenServiceIdReturnsNull()
        {
            // arrange
            Mock<ILogger> mockLogger = new Mock<ILogger>();
            var mockRequest = Mockers.MockRequest(null);
        ...
        public async Task WithIncorrectUserIdReturnsNull()
        {
            ...
            fakeBlobRepo.Blobs.Clear();
            fakeBlobRepo.AddFakeBlob(Mockers.MyEdenServiceContainerName, $"user2id/{Mockers.DefaultId}");
